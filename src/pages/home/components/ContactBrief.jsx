      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="p-10 md:p-16 bg-[#002855] text-white">
          ...
          <div className="space-y-8">
            <div>
              <p className="text-[9px] font-bold uppercase tracking-widest text-white/40 mb-2">Redacción Central</p>
              <p className="text-xl font-serif italic">Calle de la Pasión, 4. Valladolid, España.</p>
            </div>
            <div>
              <p className="text-[9px] font-bold uppercase tracking-widest text-white/40 mb-2">Canal Ético y Filtraciones</p>
              <p className="text-xl font-serif italic">redaccion@elalbatros.live</p>
            </div>
            <div>
              <p className="text-[9px] font-bold uppercase tracking-widest text-white/40 mb-2">Atención al Socio</p>
              <p className="text-xl font-serif italic">+34 983 000 000</p>
            </div>
          </div>
        </div>
